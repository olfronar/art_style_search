...
class TestPerImageComposite:
    def test_weights_sum_to_roughly_one(self) -> None:
        ...
        """
        perfect = _make_scores(ds=1.0, hps=0.35, aes=10.0, color=1.0, ssim=1.0, vs=1.0, vsu=1.0, vc=1.0)
    ...
    def test_zero_scores_give_zero(self) -> None:
        zeros = _make_scores(ds=0.0, hps=0.0, aes=0.0, color=0.0, ssim=0.0, vs=0.0, vsu=0.0, vc=0.0)
