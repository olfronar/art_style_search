...
async def synthesize_templates(
    ...
    *,
    ...
    system = (
        ...
        "- The merged 'style_foundation' MUST preserve the six-slot [Art Style] SKELETON from the parents "
        "(How to Draw / Shading & Light / Color Principle / Surface & Texture / Stylization Attitude / "
        "Level of Detail) and the anti-name preamble forbidding genre labels. Silently dropping a slot or "
        "re-introducing style-naming inside [Art Style] is a regression.\n\n"
        "## Decision guidance\n"
        ...
        "- [ ] style_foundation preserves all six [Art Style] skeleton slots and the anti-name preamble\n\n"
        "Response format:\n"
        "{\n"
        '  "rationale": "...",\n'
        '  "template": {\n'
