...
_BASE_REQUIREMENTS = (
    ...
    "5. 'style_foundation.value' MUST include a 'How to Draw:' sub-block naming: silhouette primitives, "
    ...
    "texture grain, and one signature rendering quirk.\n"
...
def _expand_system() -> str:
    return (
        ...
        "inside every caption's [Art Style] block. It MUST include a 'How to Draw:' sub-block (silhouette "
        "primitives / construction order / line policy / shading layers / edge softness / grain / signature quirk) "
        "and name the observed medium class (A/B/C/D/E) with class-appropriate vocabulary.\n"
