...
def _experiment_system_prompt(
    *, current_template: PromptTemplate, response_format: str, is_first_iteration: bool = False
    ...
    base = (
        ...
        "4. style_foundation.value MUST realize the six-slot [Art Style] SKELETON: "
        ...
        "Refinements may reword slots but MUST keep all six present.\n"
        ...
        "8. STYLE-DNA PURITY: style_foundation / [Art Style] carries REUSABLE style DNA only. Its palette paragraph "
        ...
        "[Color Palette] or [Subject] — they are per-image observations, not style DNA. A meta-prompt that invites "
        "image-specific palette contamination in [Art Style] is a regression. Additionally, genre labels "
        "('3D CGI of X', 'cel-shaded anime', '{Artist}-style', 'watercolor illustration') are forbidden inside "
        "[Art Style] — describe HOW the style is rendered, never NAME the genre.\n\n"
    ...
    if is_first_iteration:
        context = (
            ...
            "First: [Art Style] (shared style DNA realized via the six-slot skeleton — "
            "How to Draw / Shading & Light / Color Principle / Surface & Texture / Stylization Attitude / "
            "Level of Detail — identical across captions, target 600-1200 words). "
...
def _expand_system(current_template: PromptTemplate, *, is_first_iteration: bool = False) -> str:
    return _experiment_system_prompt(
        ...
        response_format=(
            ...
            "- [ ] style_foundation.value realizes the six-slot [Art Style] skeleton "
            "(How to Draw / Shading & Light / Color Principle / Surface & Texture / Stylization Attitude / "
            "Level of Detail) and carries the anti-name preamble forbidding genre labels\n"
