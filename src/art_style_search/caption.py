...
CAPTION_PROMPT = (
    ...
    "(1) How to Draw (medium identification in plain observable vocabulary + line/edge policy describing the "
    "**finished surface** — NO construction steps, primitives, or fabrication), "
