...
CAPTION_SYSTEM = (
    ...
    "Medium-class cues — classify EXACTLY ONE of A/B/C/D/E and use class-appropriate vocabulary only (no cross-mixing):\n"
    ...
    "    C. stylized 3D CGI — rounded bevels, subdivision-smooth gradients, AO in creases, rim light, matte plastic/fondant surfaces, no outlines\n"
