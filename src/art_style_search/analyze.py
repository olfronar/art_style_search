...
_COMPILATION_PROMPT = (
    ...
    "- 'style_foundation.value' MUST realize the six-slot [Art Style] SKELETON — describe HOW the style "
    "is rendered, never NAME the genre. Start with the literal 'How to Draw:' marker. The six slots are:\n"
    ...
    "structure (key + contrast); saturation policy (uniform / selective chroma / muted).\n"
    ...
    "    5. Stylization Attitude: body-deformation policy (heads-tall archetype itself lives in "
    "subject_anchor); one signature rendering quirk; mood register in one clause.\n"
    "    6. Level of Detail: detail density (low-poly / mid / filigree); abstraction stance "
    "(graphic / illustrative / naturalistic).\n"
    ...
    "- [ ] style_foundation.value realizes the six-slot [Art Style] skeleton, starting with the literal 'How to Draw:' marker\n"
    "- [ ] style_foundation carries the anti-name preamble forbidding genre labels inside [Art Style]\n"
