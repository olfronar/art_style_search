...
_COMPILATION_PROMPT = (
    ...
    "- 'style_foundation.value' MUST contain a 'How to Draw:' sub-block enumerating: silhouette primitives, "
    "construction order (head -> torso -> limbs -> props), line policy (none / thin uniform / variable ink / "
    "painterly / crease-only), shading layers in order (base -> AO -> midtones -> rim -> specular), edge softness, "
    "texture grain, and one signature rendering quirk. This is the operational spine of the style.\n"
    ...
    "- [ ] style_foundation.value contains a 'How to Draw:' sub-block (primitives + construction + line + shading + grain + quirk)\n"
