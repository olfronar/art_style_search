...
_COMPILATION_PROMPT = (
    ...
    "reach for words the analyses did not use, and do NOT pull from an implicit menu. If the analyses describe "
    "ink hatching, describe ink hatching; if they describe lit volumes, describe lit volumes; if they describe "
    "vector registration, describe vector registration; if they describe washed gradients, describe washed "
    "gradients:\n"
    "    1. How to Draw (open with the literal marker 'How to Draw:' on its own sub-line). Write declarative "
    "sentences that identify the medium in plain observable vocabulary matching what the two analyses reported, "
    "followed by assertions about construction order and line policy as the analyses described them.\n"
